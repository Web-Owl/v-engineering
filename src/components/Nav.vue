...
export default {
  ...
  created() {
    function bringmenu() {
      800 < document.body.scrollTop || 800 < document.documentElement.scrollTop
              ...
              if (o[j].tagName) {
                ...
                switch (o[j].tagName.toLowerCase()) {
                  case "a":
                    ...
                    if ($(link).attr("href") !== "#s10") item.appendChild(link);
                    break;
                  case "ul":
        ...
        scroll: function (e) {
          ...
          if (
            ...
            if (e.originalEvent.targetTouches) {
              ...
              delta =
                (e.originalEvent.wheelDelta || -e.originalEvent.detail) * -50;
            }
...
<template>
  <nav class="nav" style="display: none">
    <ul data-type="navbar" class="sf-menu">
      ...
      <li>
        <a class="nav-link" href="#s7">Реализованные проекты</a>
      </li>
      <li>
        <a class="nav-link" href="#s10">Как нас найти</a>
      </li>
      <li class="lasts">
