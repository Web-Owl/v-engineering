...
нашей компании</h3>
<ul>
<li>Доступ к видеокамерам<br />
в любой точке мира<br />
с телефона и компьютера</li>
<li>Запись звука</li>
<li>Распознавание лиц и номеров<br />
автомобилей</li>
<li>Высокий уровень<br />
безопасности видеоданных</li>
<li>Возможность хранения<br />
информации до 6 месяцев</li>
<li>Качественный и аккуратный монтаж<br />
значительно продлевает срок стабильной работы системы. Возможность покраски камер в любой цвет</li>
<li>Работа по договору с прописанной ответственностью и гарантийными обязательствами. Работа с НДС</li>
<li>Бесплатная поддержка и консультации для наших клиентов</li>
<li>Многолетняя безупречная репутация нашей компании подтвержденная отзывами на сервисах яндекс и гугл</li>
</ul>
        </div>
                        <div class="item">
