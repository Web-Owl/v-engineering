...
<template>
    ...
    <div class="container">
        <div class="header">
            <h2>
                Как получить <span>готовую систему за <mark>2 дня</mark></span>            </h2>
        </div>
        <div class="content grid">
            <div class="item">
                    ...
                    <p>Мы подробно Вас консультируем и отвечаем <br>на все Ваши вопросы. Называем примерную <br>стоимость системы для Вашего объекта</p>
                                    <h2>60 минут</h2>
                    <p>К Вам на объект бесплатно выезжает замерщик, <br>для составления точной сметы.</p>
                                    <h2>48 часов</h2>
                    <p>Готовая система видеонаблюдения.</p>
                            </div>
            <div class="item">
                <div role="form" class="wpcf7" id="wpcf7-f209-o3" lang="ru-RU" dir="ltr">
<div class="screen-reader-response"><p role="status" aria-live="polite" aria-atomic="true"></p> <ul></ul></div>
<form action="/#wpcf7-f209-o3" method="post" class="wpcf7-form init form1" novalidate="novalidate" data-status="init">
<div style="display: none;">
<input type="hidden" name="_wpcf7" value="209" />
<input type="hidden" name="_wpcf7_version" value="5.5.6" />
<input type="hidden" name="_wpcf7_locale" value="ru_RU" />
<input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f209-o3" />
